...
Salam Everyone! We created this website for the Causality Group at [East West University, Bangladesh](https://www.ewubd.edu/). We are a group of researchers and students at the Economics department interested in causal inference and its applications in various fields. Our goal is to share knowledge, resources, and tools related to causal inference, and to foster collaboration among researchers and practitioners.

Currently the plan is to read and discuss some papers on causal inference. The group is ideally open to anyone who is interested in learning about causal inference, regardless of their background or level of expertise. The only condition as a member is that you have to read a paper for every session and then present it in the group... 
